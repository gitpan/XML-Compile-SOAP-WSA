...
XML::Compile::SOAP::WSA-E<gt>B<wsdl11Init>(WSDL, ARGS)
...
$obj-E<gt>B<soap11ClientWrapper>(OPERATION, CALL, ARGS)
...
$obj-E<gt>B<soap11HandlerWrapper>(OPERATION, CALLBACK, ARGS)
...
$obj-E<gt>B<soap11OperationInit>(OPERATION, ARGS)

XML::Compile::SOAP::WSA-E<gt>B<soap11OperationInit>(OPERATION, ARGS)
...
This module is part of XML-Compile-SOAP-WSA distribution version 0.12,
